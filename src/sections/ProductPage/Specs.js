    ...
    <Grid container direction="row" justifyContent="center" alignItems="flex-start" spacing={2}>
      <Grid item xs={12} lg={6}>
        ...
        <Typography variant="body1" component={'div'}>
          ...
          {packed_notes && <div dangerouslySetInnerHTML={{ __html: packed_notes }} />}
        </Typography>
      </Grid>
      <Grid item xs={12} lg={6}>
        <Typography marginBottom={2} variant="h5">
        ...
        <Typography variant="body1" component={'div'}>
          {in_use_weight_rating && (
            <p>
              <b>Weight Rating:</b>{' '}
              {`${in_use_weight_rating} lbs (${Number(convertLbToKg(in_use_weight_rating))} kg)`}
            </p>
          )}
          {in_use_length && (
            <p>
          ...
          {in_use_notes && <div dangerouslySetInnerHTML={{ __html: in_use_notes }} />}
        </Typography>
      </Grid>
    </Grid>
  );
