                ...
                <Grid container>
                  ...
                  <Grid item xs={9}>
                    <Stack direction={'column'} spacing={2}>
                      <Typography>{item.lineItem.name}</Typography>
                      <Stack direction={'row'} justifyContent={'space-between'}>
                        <Stack>
                          <Typography variant="caption">Price Paid:</Typography>
                      ...
                      <Divider />
                      <Stack>
                        <Typography variant="caption">{item.returnReason}:</Typography>
                        <Typography>{item.customerComments}</Typography>
                      </Stack>
                    </Stack>
                  </Grid>
                </Grid>
