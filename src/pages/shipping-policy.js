...
const ShippingPolicyPage = () => (
  <Layout>
    ...
    <Info subTextAlign="left" title="SHIPPING POLICY">
      ...
      dates. If you need an order for a time sensitive event, please order well
      ahead of time. Allow at least 2 weeks for domestic orders, and 4 weeks for
      international orders to ensure you order arrives in time. <br /> <br />{" "}
      All orders are subject to product availability. <br /> <br /> We ship
      ...
      <br />
      <br />
      We offer free shipping on orders within the United States. Our primary
      shipping methods for free-shipping orders are USPS First Class and USPS
      Priority, depending on the size of the order. We may also use other
      carriers for free-shipping orders, depending on shipping rates.
      ...
      <br />
      <br />
      We do not profit from shipping. Your shipping cost is calculated based on
      the weight and size of your order. You are charged what we are charged by
      the shipping company in addition to a small handling fee.
      <br /> <br />
      To find out how much your shipping will cost, simply add all the items you
      wish to order to your cart and proceed to the checkout page. Once at the
      checkout page you will be able to see your shipping charges added to your
      total cost.
      <br /> <br />
      ...
      will not pay for any additional charges incurred by importing our
      products. Please account for the additional charges required by your
      ...
      , and we will assist you in correcting your order.
    </Info>
  </Layout>
)
