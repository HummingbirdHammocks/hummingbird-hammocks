...
const PrivacyPolicyPage = () => (
  <Layout>
    ...
    <Info subTextAlign="left" title="Privacy Policy">
      ...
      when you visit or make a purchase from hummingbird-hammocks.com (the “Site”).
      <br />
      <br />
      <br />
      ...
      <br />
      <br />
      We collect Device Information using the following technologies: - “Cookies” are data files
      that are placed on your device or computer and often include an anonymous unique identifier.
      ...
      payment information (including credit card numbers and account IDs), email address, and phone
      ...
      the Site (including processing your payment information, arranging for shipping, and providing
      you with invoices and/or order confirmations). Additionally, we use this Order Information to:
      - Communicate with you; - Screen our orders for potential risk or fraud; and - When in line
      with the preferences you have shared with us, provide you with information or advertising
      ...
      .
      <br /> <br />
      We use FreeScout to provide customer service--this service is hosted internally and your data
      is not shared to a third party.
      <br /> <br />
      We use ShipStation to provide order and returns fulfillment--you can read more about how
      ShipStation uses your Personal Information here:{' '}
      <a
        href="https://www.shipstation.com/privacy-policy/"
        target="_blank"
      ...
      .
      <br /> <br />
      We also use Google Analytics to help us understand how our customers use the Site -- you can
      ...
      records unless and until you ask us to delete this information <br />
      <br />
      <b>YOUR RIGHTS</b> <br />
      <br />
      If you are a European resident, you have the right to access personal information we hold
      ...
      to our practices or for other operational, legal or regulatory reason
      <br /> <br />
      Additionally, if you are a European resident we note that we are processing your information
      in order to fulfill contracts we might have with you (for example if you make an order through
      the Site), or otherwise to pursue our legitimate business interests listed above.
      ...
      <a href="mailto:help@hummingbirdhammocks.com">help@hummingbirdhammocks.com</a> or by mail
      ...
      <br />
      Chris Loidolt <br />
      18611 Cherry Springs Ranch Dr, Monument, CO 80132
    </Info>
  </Layout>
);
