...
const ExplorePage = () => {
  ...
  return (
    <Layout>
      ...
      <Info>
        Nearly a decade ago, our founder, certified Parachute Rigger Chris Loidolt, envisioned a
        hammock crafted from quality parachute material. Today, we've become a thriving, family-run
        business centered around producing ultralight, small-packing hammocks.
        <br />
        <br />
        Our products, derived from authentic parachute materials, use design principles inspired by
        the Parachute Industry Association. The outcome is market-leading hammocks that are
        stronger, lighter, and more compact than anything else on the market.
        <br />
        <br />
        Being a direct-to-consumer business allows us to maintain a strong bond with our customers,
        providing the highest possible quality gear for the price by minimizing overhead and
        eliminating retail markups. Our open-source design philosophy encourages a collaborative
        community that supports innovation and mutual growth.
        <br />
        <br />
        We're proud to offer a lifetime guarantee on all our products, a testament to our confidence
        in their quality and durability. Furthermore, our commitment to sustainability ensures we
        actively strive to reduce our environmental impact, using responsibly sourced materials and
        eco-friendly practices.
        <br />
        <br />
        Join us in revolutionizing how we enjoy nature, and help us reshape outdoor relaxation, one
        hammock at a time.
      </Info>
