                ...
                <List disablePadding>
                  {customerSupport.map((customer) => (
                    <ListItem sx={{ p: '10px 0' }} key={customer.id}>
                      <AnotherLink color="white.main" href={customer.url} underline="none">
                        <Typography variant="footerMenu">{customer.name}</Typography>
                      </AnotherLink>
                    </ListItem>
                  ))}
                </List>
                ...
                {companyLink.map((company) => (
                  <ListItem key={company.id} sx={{ p: '10px 0' }}>
                    <Link
                      ...
                      color="white.main"
                      to={company.url}>
                      <Typography variant="footerMenu">{company.name}</Typography>
                    </Link>
                  </ListItem>
                ))}
              </List>
