  ...
  return (
    <CookieConsent
      ...
      <Typography variant="body2" color="white" sx={{ padding: 0.5 }}>
        <b>We Value Your Privacy</b>: This website uses cookies to ensure you get the best
        experience on our website, and to analyze traffic.
        <br />
        By continuing to use this website, you consent to the use of cookies in accordance with our{' '}
        <Link to="/privacy-policy" sx={{ color: '#FFFFFF' }}>
          Privacy Policy
        </Link>
      </Typography>
    </CookieConsent>
