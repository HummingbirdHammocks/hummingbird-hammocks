...
exports.create_ticket = async function (req, res) {
    ...
    return await createTicket(req.body.firstName, req.body.lastName, req.body.email, req.body.subject, req.body.message, req.body.orderNumber, req.body.attachments)
